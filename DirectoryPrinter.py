...
# Set up environment
root = ctk.CTk()
root.title("Directory Printer - byTravis")
...
include_path = ctk.CTkCheckBox(options_container, text="Include folder path?", variable=include_path_status, onvalue="on", offvalue="off",
...
include_directories = ctk.CTkCheckBox(options_container, text="Include folders?", variable=include_directories_status, onvalue="on", offvalue="off",
									border_width=cb_border, checkbox_height=cb_height, checkbox_width=cb_width, corner_radius=cb_radius)
...
open_dir_btn = ctk.CTkButton(btn_container, text="Open Folder", command=open_dir)
